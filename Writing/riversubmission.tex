...
\usepackage{rivps}
%\usepackage[mtbold]{mathtime} %Unable to find a compilable one...
...
\begin{opening}
	...
	\institute{University of Bristol,  \texttt{\{y.yan elisabeth.oswald theo.tryfonas\}@bristol.ac.uk}}
\end{opening}

\runningtitle{Exploring Potential 6LoWPAN Traffic Side Channels}
\runningauthor{Y. Yan, E. Oswald, T. Tryfonas}
...
\begin{figure}
	...
	\centerline{\includegraphics[width=\textwidth]{fig/PingProbe_Theory.png}}
\end{figure}
...
\begin{figure}
	...
	\centerline{\includegraphics[width=\textwidth]{fig/PRI_hl.png}}
\end{figure}
...
\begin{figure}
	\centering
	\subfigure[PRIs of helloworld\label{HelloworldPriNormal}]
	{
		\includegraphics[width=0.45\textwidth]{fig/helloworld_cc2538.png}
	}
	\subfigure[PRIs outliers of helloworld\label{HelloworldPriOutliers}]
	{
		\includegraphics[width=0.45\textwidth]{fig/helloworld_cc2538_outlier.png}
	}
%	\begin{subfigure}{0.45\textwidth}
%		\includegraphics[width=\textwidth]{fig/helloworld_cc2538_outlier.png}
%		\caption{PRIs outliers of helloworld\label{HelloworldPriOutliers}}
...
\begin{table}
	\centering
	\caption{Fingerprint Experiment Programs \label{FingerprintApps}}
...
\begin{sidewaystable}
	...
	\caption{
		...
		Minimum in each row marked as \textbf{bold}.) \label{ksdistances}
	}
